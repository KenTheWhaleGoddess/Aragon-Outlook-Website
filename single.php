...
<!-- Print button --> <?php if(function_exists('pf_show_link')){echo pf_show_link();} ?>
        ...
        <div class="entry">
			...
			<!-- <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="Posts by <?php the_author(); ?>"><?php the_author(); ?></a>--></span>
			<?php
    ...
    the_author_posts_link(); ?>
			 on <span
                        class="post-date"><a data-instant href="/<?php the_time(__('Y')) ?>/<?php the_time(__('m')) ?>/"><?php the_time(__('F j, Y')) ?></a></span>. <!--&bull; <span><?php the_time() ?></span>--> <?php edit_post_link( __( 'Edit entry'), '&bull; '); ?><a href="#livefyre-comments" class="post-comms"><?php comments_number(__('No Comments'), __('1 Comment'), __('% Comments'), '', __('Comments Closed') ); ?></a></div>
			...
			<div class="bottom-share-buttons">
				<ul>
					<li id="FB" style="margin: 0 0 0 20px; float: left; max-height: 40px;">
						<iframe src="//www.facebook.com/plugins/like.php?href=<?php the_permalink(); ?>&amp;width=125&amp;height=46&amp;colorscheme=light&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;send=true&amp;appId=146716895537285" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:125px; height:46px;" allowTransparency="true"></iframe>
					</li>

					<li id="Twit">
						<a href="https://twitter.com/share" class="twitter-share-button" data-via="aragonoutlook" data-dnt="true">Tweet</a>
